...
(function (ba) {
  ...
  function U(b, c, d, e) {
    c && A(c, function (c, i) {
      if (d || !t(b, i))
        e && 'object' === typeof c && c && !H(c) && !G(c) && !(c instanceof RegExp) ? (b[i] || (b[i] = {}), U(b[i], c, d, e)) : b[i] = c;
    });
    return b;
  }
  function u(b, c) {
  ...
  function ga(b) {
    ...
    function D() {
      var a, b, c = (a = 1000 * k.waitSeconds) && h.startTime + a < new Date().getTime(), f = [], l = [], e = !1, i = !0;
      if (!W) {
        W = !0;
        A(V, function (a) {
          var h = a.map, g = h.id;
        ...
        if (c && f.length)
          return a = B('timeout', 'Load timeout for modules: ' + f, null, f), a.contextName = h.contextName, w(a);
        i && v(l, function (a) {
          F(a, {}, {});
        });
        if ((!c || b) && e)
    ...
    Z.prototype = {
      ...
      fetch: function () {
        if (!this.fetched) {
          ...
          var a = this.map;
          if (this.shim)
            h.makeRequire(this.map, { enableBuildCallback: !0 })(this.shim.deps || [], u(this, function () {
  ...
  x = Object.prototype;
  var K = x.toString, fa = x.hasOwnProperty, z = !!('undefined' !== typeof window && 'undefined' !== typeof navigator && window.document), ea = !z && 'undefined' !== typeof importScripts, ia = z && 'PLAYSTATION 3' === navigator.platform ? /^complete$/ : /^(complete|loaded)$/, Y = 'undefined' !== typeof opera && '[object Opera]' === opera.toString(), F = {}, s = {}, R = [], M = !1;
